...
keys = [
    ...
    Key([mod, "shift"], "d", lazy.spawn(os.path.expanduser("~/.config/polybar/blocks/scripts/launcher.sh")),
        desc="Rofi launcher",
    ),
    ...
    Key(
        [mod, "control"],
        "q",
        lazy.spawn(os.path.expanduser("~/.config/polybar/blocks/scripts/powermenu.sh")),
        desc="Rofi powermenu",
    ),
    #Key(
    #    [mod, "shift", "control"],
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    ...
                    padding=0,
                    mouse_callbacks={
                        "Button1": lambda: qtile.cmd_spawn(os.path.expanduser("~/.config/polybar/blocks/scripts/launcher.sh"))
                    },
                ),
                widget.TextBox(
                    text="\ue0be",
                ...
                widget.TextBox(
                    ...
                    foreground=colors[0],
                    mouse_callbacks={
                        "Button1": lambda: qtile.cmd_spawn(os.path.expanduser("~/.config/polybar/blocks/scripts/powermenu.sh"))
                    },
                ),
                #widget.Sep(
                #    padding=6,
